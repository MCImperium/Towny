...
public class GuiContainer implements Container, StackedContentsCompatible {
	...
	public GuiContainer(ItemStack... p_19152_) {
	...
	public void setContents(GuiContainer other) {
		for (int i = 0; i < items.size(); i++) {
			items.set(i, other.getItem(i));
		}
	}
}
