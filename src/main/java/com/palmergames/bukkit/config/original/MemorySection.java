package com.palmergames.bukkit.config.original;

import com.google.common.base.Preconditions;
import com.google.common.base.Strings;
import com.mojang.math.Vector3d;
import com.palmergames.bukkit.config.original.serialization.ConfigurationSerializable;
...
public class MemorySection implements ConfigurationSection {
    ...
    @Override
    @Nullable
    public Vector3d getVector(@NotNull String path) {
    ...
    @Contract("_, !null -> !null")
    @Nullable
    public Vector3d getVector(@NotNull String path, @Nullable Vector def) {
    ...
    @Override
    @Nullable
    public BlockPos getLocation(@NotNull String path) {
        return getSerializable(path, BlockPos.class);
    }

    @Override
    @Contract("_, !null -> !null")
    @Nullable
    public BlockPos getLocation(@NotNull String path, @Nullable BlockPos def) {
        return getSerializable(path, BlockPos.class, def);
    }

    @Override
    public boolean isLocation(@NotNull String path) {
        return getSerializable(path, BlockPos.class) != null;
    }
