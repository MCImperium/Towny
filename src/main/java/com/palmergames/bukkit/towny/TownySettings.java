...
public class TownySettings {
	...
	public static void loadTownLevelConfig() throws IOException {
		...
		for (Map<?, ?> genericLevel : levels) {
			...
			try {
				...
				Towny.getPlugin().getLogger().warn("The town_level section of you Towny config.yml is out of date.");
				Towny.getPlugin().getLogger().warn("This can be fixed automatically by deleting the town_level section and letting Towny remake it on the next startup.");
	...
	public static void loadNationLevelConfig() throws IOException {
		...
		for (Map<?, ?> level : levels) {
			...
			try {
				...
				Towny.getPlugin().getLogger().warn("The nation_level section of your Towny config.yml is out of date.");
				Towny.getPlugin().getLogger().warn("This can be fixed automatically by deleting the nation_level section and letting Towny remake it on the next startup.");
	...
	public static void sendError(String msg) {
		Towny.getPlugin().getLogger().warn(() -> String.format("Error could not read %s",msg));
	}
	...
	public static String getCapitalPostfix(Town town) {
		...
		try {
			return ChatFormatting.translateAlternateColorCodes('&', getNationLevel(town.getNation()).capitalPostfix());
		} catch (NotRegisteredException e) {
	...
	public static String getTownPostfix(Town town) {
		...
		try {
			return ChatFormatting.translateAlternateColorCodes('&', getTownLevel(town).namePostfix());
		} catch (Exception e) {
	...
	public static String getNationPostfix(Nation nation) {
		...
		try {
			return ChatFormatting.translateAlternateColorCodes('&', getNationLevel(nation).namePostfix());
		} catch (Exception e) {
	...
	public static String getNationPrefix(Nation nation) {
		...
		try {
			return ChatFormatting.translateAlternateColorCodes('&', getNationLevel(nation).namePrefix());
		} catch (Exception e) {
	...
	public static String getTownPrefix(Town town) {
		...
		try {
			return ChatFormatting.translateAlternateColorCodes('&', getTownLevel(town).namePrefix());
		} catch (Exception e) {
	...
	public static String getCapitalPrefix(Town town) {
		...
		try {
			return ChatFormatting.translateAlternateColorCodes('&', getNationLevel(town.getNation()).capitalPrefix());
		} catch (NotRegisteredException e) {
	...
	/**
	 * For compatibility with custom plot types, this has been deprecated. Please use {@link #isSwitchMaterial(Material, BlockPos)} instead.
	...
	public static boolean isSwitchMaterial(Material material, BlockPos location) {
	...
	/**
	 * For compatibility with custom plot types, this has been deprecated. Please use {@link #isItemUseMaterial(Material, BlockPos)} instead.
	 * @param mat The name of the material.
	...
	public static boolean isItemUseMaterial(Material material, BlockPos location) {
		TownBlock townBlock = TownyAPI.getInstance().getTownBlock(location);
