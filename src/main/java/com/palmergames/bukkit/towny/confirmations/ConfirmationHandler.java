...
public class ConfirmationHandler {
	...
	private final static Map<Player, ConfirmationContext> confirmations = new ConcurrentHashMap<>();
	 ...
	 */
	public static void revokeConfirmation(Player sender) {
	 ...
	 */
	public static void sendConfirmation(Player sender, Confirmation confirmation) {
	 ...
	 */
	public static void acceptConfirmation(Player sender) {
		// Get confirmation
		ConfirmationContext context = confirmations.get(sender);
	...
	public static boolean hasConfirmation(Player sender) {
