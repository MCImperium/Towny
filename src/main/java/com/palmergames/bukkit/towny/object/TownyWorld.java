...
public class TownyWorld extends TownyObject {
	...
	public Map<BlockPos, Material> bedMap = new HashMap<>();
	...
	public List<String> getTreeString(int depth) {
		...
		out.add(getTreeDepth(depth) + "Level (" + getName() + ")");
	 ...
	 */
	@ApiStatus.Internal
	public boolean hasBedExplosionAtBlock(BlockPos location) {
		return bedMap.containsKey(location);
	}

	/**
	 * Gets the exploded bed material.
	 * @param location BlockPos to get the material.
	 * @return material of the bed or null if the bedMap doesn't contain the location.
	 */
	@Nullable
	@ApiStatus.Internal
	public Material getBedExplosionMaterial(BlockPos location) {
	...
	@ApiStatus.Internal
	public void addBedExplosionAtBlock(BlockPos location, Material material) {
		bedMap.put(location, material);
	}

	@ApiStatus.Internal
	public void removeBedExplosionAtBlock(BlockPos location) {
		if (hasBedExplosionAtBlock(location))
