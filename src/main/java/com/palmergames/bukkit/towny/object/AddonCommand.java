...
public class AddonCommand extends Command {
	...
	@Override
	public boolean execute(@NotNull Player sender, @NotNull String label, @NotNull String[] args) {
	 ...
	 * 
	 * @param sender Player using the addon command.
	 ...
	 * @return true if the {@link CommandExecutor#onCommand(Player, Command, String, String[])} is successful.
	 */
	public boolean execute(@NotNull Player sender, @NotNull String[] args, TownyObject object) {
	...
	public List<String> getTabCompletion(Player sender, String[] args) {
	...
	private record LegacyTabCompleter(AddonCommand command) implements TabCompleter {
		@Override
		public List<String> onTabComplete(@NotNull Player sender, @NotNull Command command, @NotNull String label, String[] args) {
