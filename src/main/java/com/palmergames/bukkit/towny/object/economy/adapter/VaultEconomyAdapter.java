...
public class VaultEconomyAdapter implements EconomyAdapter {
	...
	@Override
	public boolean add(String accountName, double amount, Level world) {
		return economy.depositPlayer(accountName, amount).type == EconomyResponse.ResponseType.SUCCESS;
	}

	@Override
	public boolean subtract(String accountName, double amount, Level world) {
	...
	@Override
	public double getBalance(String accountName, Level world) {
	...
	@Override
	public boolean setBalance(String accountName, double amount, Level world) {
