...
public class Town extends Government implements TownBlockOwner {
	...
	private List<BlockPos> outpostSpawns = new ArrayList<>();
	...
	public boolean hasResident(Player player) {
		...
		return hasResident(player.getUUID());
	}
	...
	/**
	 * Fetch the Level this town homeblock is registered too.
	...
	@Override
	public BlockPos getSpawn() throws TownyException {
	...
	@Nullable
	@Override
	public BlockPos getSpawnOrNull() {
		return spawn;
	}
	 ...
	 * 
	 * @param spawn - BlockPos to set an outpost's spawn point
	 */
	public void addOutpostSpawn(BlockPos spawn) {
	 ...
	 * Only to be called from the Loading methods.
	 * 
	 * @param spawn - BlockPos to set Outpost's spawn point
	 */
	public void forceAddOutpostSpawn(BlockPos spawn) {
		outpostSpawns.add(spawn);
		TownyUniverse.getInstance().addSpawnPoint(new SpawnPoint(spawn, SpawnPointType.OUTPOST_SPAWN));
	}

	/**
	 * Return the BlockPos for this Outpost index.
	 * 
	 * @param index - Numeric identifier of an Outpost
	 * @return BlockPos of Outpost's spawn
	 * @throws TownyException if there are no Outpost spawns set
	 */
	public BlockPos getOutpostSpawn(Integer index) throws TownyException {
	 ...
	 */
	public List<BlockPos> getAllOutpostSpawns() {
	...
	public void removeOutpostSpawn(BlockPos loc) {
	...
	public void setOutpostSpawns(List<BlockPos> outpostSpawns) {
	 ...
	 */
	public boolean isInsideTown(@NotNull BlockPos location) {
