...
public final class Translation {
	...
	public static String of(String key) {
		if (defaultLocale == null) {
			Towny.getPlugin().getLogger().warn("Error: Tried to translate before a locale could be loaded!");
			return key;
		}
	...
	public static String of(String key, Object... args) {
		...
		try {
			...
			Towny.getPlugin().getLogger().warn("An exception occurred when formatting translation '" + translated + "' for {key=" + key + ",args=" + Arrays.toString(args) + "}, see the below error for more details");
			e.printStackTrace();
			return translated;
		}
	}
	...
	public static String of(String key, Locale locale, Object... args) {
		...
		try {
			...
			Towny.getPlugin().getLogger().warn("An exception occurred when formatting translation '" + translated + "' for {key=" + key + ",locale=" + locale.toString() + ",args=" + Arrays.toString(args) + "}, see the below error for more details");
			e.printStackTrace();
			return translated;
		}
	}
	
	public static String of(String key, Player sender) {
		return of(key, getLocale(sender));
	}
	
	public static String of(String key, Player sender, Object... args) {
	...
	public static Locale toLocale(String fileName, boolean shouldWarn) {
		...
		try {
			...
			if (shouldWarn)
				Towny.getPlugin().getLogger().warn(String.format("Could not convert '%s' into a locale, falling back to en_US.", fileName));
	...
	private static Locale loadDefaultLocale() {
		...
		if (!translations.containsKey(stringLocale)) {
			...
			Towny.getPlugin().getLogger().warn(String.format("The locale '%s' is currently not loaded, falling back to en_US. (Is it being loaded correctly?)", stringLocale));
		}
	...
	public static String translateTranslatables(Player sender, Translatable... translatables) {
		return translateTranslatables(sender, " ", translatables);
	}
	
	public static String translateTranslatables(Player sender, String delimiter, Translatable... translatables) {
	...
	public static Locale getLocale(Player sender) {
		return defaultLocale;
