...
import com.palmergames.bukkit.util.BlockPosRunnable;
...
public class CellBorder extends WorldCoord {
	...
	public void runBorderedOnSurface(int wallHeight, int cornerHeight, Consumer<BlockPos> locationConsumer) {
	 ...
	 */
	@Deprecated
	public void runBorderedOnSurface(int wallHeight, int cornerHeight, BlockPosRunnable runnable) {
		runBorderedOnSurface(wallHeight, cornerHeight, (Consumer<BlockPos>) runnable::run);
	}
