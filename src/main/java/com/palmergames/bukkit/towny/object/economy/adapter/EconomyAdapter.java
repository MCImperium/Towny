...
public interface EconomyAdapter {
	 ...
	 */
	boolean add(String accountName, double amount, Level world);
	 ...
	 * @return A boolean indicating success.
	 */
	boolean subtract(String accountName, double amount, Level world);
	 ...
	 * @return A boolean indicating success.
	 */
	double getBalance(String accountName, Level world);
	 ...
	 * @return A boolean indicating success.
	 */
	boolean setBalance(String accountName, double amount, Level world);
