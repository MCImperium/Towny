 ...
 */
public abstract class Government extends TownyObject implements BankEconomyHandler, ResidentList, Inviteable, Identifiable, SpawnBlockPos, ForwardingAudience {
	
	protected UUID uuid;
	protected BankAccount account;
	protected BlockPos spawn;
	 ...
	 * 
	 * @return The {@link Level} this object is in.
	 */
