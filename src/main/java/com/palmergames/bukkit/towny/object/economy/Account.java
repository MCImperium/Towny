...
public abstract class Account implements Nameable {
	...
	public Account(String name) {
		...
		try {
			...
			Towny.getPlugin().getLogger().warn(String.format("An exception occurred when initializing cached balance for an account (name: %s), see the below error for more details.", name));
			e.printStackTrace();
	...
	public Account(String name, Level world) {
		this(name);
		this.world = world;
	}
