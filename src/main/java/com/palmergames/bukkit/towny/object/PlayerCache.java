...
public class PlayerCache {
	...
	public PlayerCache(TownyWorld world, Player player) {
		...
		setLastBlockPos(player.getBlockPos());
	}
	 ...
	 * 
	 * @param worldCoord - Level Coordinate to set as the lastWorldCoord
	 */
	 ...
	 * 
	 * @param worldCoord - Level Coordinate to setLastTownBlock
	 */
	...
	public void setLastBlockPos(BlockPos lastBlockPos) {
		...
		this.lastBlockPos = lastBlockPos.clone();
	}

	public BlockPos getLastBlockPos() throws NullPointerException {
