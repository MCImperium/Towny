...
public class ProtectionRegenTask extends TownyTimerTask {
	...
	public ProtectionRegenTask(Towny plugin, Block block) {
		...
		this.setBlockBlockPos(new BlockLoc(block.getBlockPos()));
	...
	/**
	 * @return the blockBlockPos
	 */
	public BlockLoc getBlockBlockPos() {

		return blockLoc;
	}

	/**
	 * @param blockLoc the blockBlockPos to set
	 */
	private void setBlockBlockPos(BlockLoc blockLoc) {
