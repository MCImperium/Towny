...
public class MapHUD {
	...
	public static void toggleOn(Player player) {
		...
		String townEntry = ChatFormatting.DARK_GREEN + Translatable.of("town_sing").forLocale(player) + ": ";
		String ownerEntry = ChatFormatting.DARK_GREEN + Translatable.of("owner_status").forLocale(player) + ": ";
	...
	public static void updateMap(Player player, WorldCoord wc) {
		...
		objective.setHoverName(ChatFormatting.GOLD + "Towny Map " + ChatFormatting.WHITE + "(" + wc.getX() + ", " + wc.getZ() + ")");
		...
		board.getTeam("townTeam").setSuffix(ChatFormatting.GREEN + (tb != null && tb.hasTown() ? tb.getTownOrNull().getName() : Translatable.of("status_no_town").forLocale(player)));
		board.getTeam("ownerTeam").setSuffix(ChatFormatting.GREEN + (tb != null && tb.hasResident() ? tb.getResidentOrNull().getName() : Translatable.of("status_no_town").forLocale(player)));
	}
