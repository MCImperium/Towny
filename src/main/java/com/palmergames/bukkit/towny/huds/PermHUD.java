...
public class PermHUD {
	...
	public static void updatePerms(Player p, WorldCoord worldCoord) {
		...
		try {
			...
			if (townBlock.hasResident()) {
				title = ChatFormatting.GOLD + townBlock.getResidentOrNull().getName() + " (" + townBlock.getTown().getName() + ")";
			} else {
				title = ChatFormatting.GOLD + townBlock.getTown().getName();
			}
		...
		board.getObjective("PERM_HUD_OBJ").setHoverName(HUDManager.check(title));
	}
	...
	private static void clearPerms (Player p) {
		...
		try {
			...
			board.getObjective("PERM_HUD_OBJ").setHoverName(HUDManager.check(getFormattedWildernessName(p.getWorld())));
		} catch (NullPointerException e) {
			toggleOn(p);
		}
	}
	
	private static String getFormattedWildernessName(Level w) {
		StringBuilder wildernessName = new StringBuilder().append(ChatFormatting.DARK_RED).append(ChatFormatting.BOLD);
	...
	public static void toggleOn (Player p) {
		Translator translator = Translator.locale(p);
		String PERM_HUD_TITLE = ChatFormatting.GOLD + "";
		String permsTitle_entry = ChatFormatting.YELLOW + "" + ChatFormatting.UNDERLINE + translator.of("msg_perm_hud_title");
		String plotName_entry = ChatFormatting.DARK_GREEN + "";
		String build_entry = ChatFormatting.DARK_GREEN + translator.of("msg_perm_hud_build") + ChatFormatting.GRAY;
		String destroy_entry = ChatFormatting.DARK_GREEN + translator.of("msg_perm_hud_destroy") + ChatFormatting.GRAY;
		String switching_entry = ChatFormatting.DARK_GREEN + translator.of("msg_perm_hud_switch") + ChatFormatting.GRAY;
		String item_entry = ChatFormatting.DARK_GREEN + translator.of("msg_perm_hud_item_use") + ChatFormatting.GRAY;
		String keyPlotType_entry = ChatFormatting.DARK_GREEN + translator.of("msg_perm_hud_plot_type");
		String pvp_entry = ChatFormatting.DARK_GREEN + translator.of("msg_perm_hud_pvp") + " ";
		String explosions_entry = ChatFormatting.DARK_GREEN + translator.of("msg_perm_hud_explosions") + " ";
		String firespread_entry = ChatFormatting.DARK_GREEN + translator.of("msg_perm_hud_firespread") + " ";
		String mobspawn_entry = ChatFormatting.DARK_GREEN + translator.of("msg_perm_hud_mobspawns") + " ";
		String keyTitle_entry = ChatFormatting.YELLOW + "" + ChatFormatting.UNDERLINE + translator.of("msg_perm_hud_key");
		String keyResident_entry = ChatFormatting.DARK_GREEN + "" + ChatFormatting.BOLD + "f" + ChatFormatting.WHITE + " - " + ChatFormatting.GRAY + translator.of("msg_perm_hud_friend") + ChatFormatting.DARK_GREEN + " " + ChatFormatting.BOLD + "r" + ChatFormatting.WHITE + " - " + ChatFormatting.GRAY + translator.of("msg_perm_hud_resident");
		String keyNation_entry = ChatFormatting.DARK_GREEN + "" + ChatFormatting.BOLD + "t" + ChatFormatting.WHITE + " - " + ChatFormatting.GRAY + translator.of("msg_perm_hud_town") + ChatFormatting.DARK_GREEN + " " + ChatFormatting.BOLD + "n" + ChatFormatting.WHITE + " - " + ChatFormatting.GRAY + translator.of("msg_perm_hud_nation");
		String keyAlly_entry = ChatFormatting.DARK_GREEN + "" + ChatFormatting.BOLD + "a" + ChatFormatting.WHITE + " - " + ChatFormatting.GRAY + translator.of("msg_perm_hud_ally") + ChatFormatting.DARK_GREEN + " " + ChatFormatting.BOLD + "o" + ChatFormatting.WHITE + " - " + ChatFormatting.GRAY + translator.of("msg_perm_hud_outsider");

		//init objective
		Scoreboard board = Bukkit.getScoreboardManager().getNewScoreboard();
		Objective obj = BukkitTools.objective(board, "PERM_HUD_OBJ", PERM_HUD_TITLE);
		obj.setDisplaySlot(DisplaySlot.SIDEBAR);
		obj.setHoverName(PERM_HUD_TITLE);
		//register teams
