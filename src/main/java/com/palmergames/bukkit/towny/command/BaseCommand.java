...
public class BaseCommand implements TabCompleter{
	 ...
	 */
	public List<String> getVisibleResidentsForPlayerWithoutTownsStartingWith(String arg, Player sender) {
	...
	protected static Town getTownFromPlayerOrThrow(Player player) throws TownyException {
		return getTownFromResidentOrThrow(getResidentOrThrow(player.getUUID()));
	}
	...
	protected static Nation getNationFromPlayerOrThrow(Player player) throws TownyException {
		return getNationFromResidentOrThrow(getResidentOrThrow(player.getUUID()));
	}
	...
	public static void catchPlayer(Player sender) throws TownyException {
		if (sender instanceof Player)
			throw new TownyException(Translatable.of("msg_err_console_only"));
	}
	
	public static Player catchConsole(Player sender) throws TownyException {
		if (!(sender instanceof Player player))
