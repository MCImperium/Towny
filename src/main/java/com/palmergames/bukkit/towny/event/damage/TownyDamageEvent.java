...
public abstract class TownyDamageEvent extends Event implements Cancellable {
	...
	protected final BlockPos loc;
	protected final DamageCause cause;
	protected final TownBlock townblock;
	protected boolean cancelled;
	protected String message;

	public TownyDamageEvent(BlockPos loc, Entity entity, DamageCause cause, TownBlock townblock, boolean cancelled) {
		this.entity = entity;
		this.loc = loc;
		this.cause = cause;
	...
	/**
	 * @return BlockPos of the entity being damaged.
	 */
