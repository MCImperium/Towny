...
public class TownyEconomyHandler {
	 ...
	 */
	public static double getBalance(String accountName, Level world) {
	 ...
	 */
	public static boolean hasEnough(String accountName, double amount, Level world) {
	 ...
	 * @return true if successful
	 */
	public static boolean subtract(String accountName, double amount, Level world) {
	 ...
	 * @return true if successful
	 */
	public static boolean add(String accountName, double amount, Level world) {
	...
	public static boolean setBalance(String accountName, double amount, Level world) {
		checkNewAccount(accountName);
	 ...
	 */
	public static boolean addToServer(double amount, Level world) {
	 ...
	 * @return A boolean indicating success.
	 */
	public static boolean subtractFromServer(double amount, Level world) {
