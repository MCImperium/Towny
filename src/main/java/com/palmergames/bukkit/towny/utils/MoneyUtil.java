...
public class MoneyUtil {
	...
	public static void townWithdraw(Player player, Resident resident, Town town, int amount) {
		...
		try {
			commonTests(amount, resident, town, player.blockPosition(), false, true);
	...
	public static void townDeposit(Player player, Resident resident, Town town, Nation nation, int amount) {
		...
		try {
			commonTests(amount, resident, town, player.blockPosition(), false, false);
	...
	public static void nationWithdraw(Player player, Resident resident, Nation nation, int amount) {
		...
		try {
			commonTests(amount, resident, nation.getCapital(), player.blockPosition(), true, true);
	...
	public static void nationDeposit(Player player, Resident resident, Nation nation, int amount) {
		...
		try {
			commonTests(amount, resident, nation.getCapital(), player.blockPosition(), true, false);
	 ...
	 * @param loc BlockPos of the player using the command.
	 ...
	 */
	private static void commonTests(int amount, Resident resident, Town town, BlockPos loc, boolean nation, boolean withdraw) throws TownyException {
	...
	private static boolean isNotInBankPlot(Town town, BlockPos loc) {
	...
	private static boolean isNotInOwnTown(Town town, BlockPos loc) {
