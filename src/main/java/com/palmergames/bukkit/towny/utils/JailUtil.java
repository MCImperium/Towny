...
public class JailUtil {
	 ...
	 * @param jailer Player of who did the jailing or null.
	 */
	public static void jailResident(Resident resident, Jail jail, int cell, int hours, JailReason reason, Player jailer){
	 ...
	 * @param jailer Player of who did the jailing or null.
	 */
	public static void jailResidentWithBail(Resident resident, Jail jail, int cell, int hours, double bail, JailReason reason, Player jailer) {
	...
	public static void createJailPlot(TownBlock townBlock, Town town, BlockPos location) throws TownyException {
		UUID uuid = UUID.randomUUID();
		List<BlockPos> jailSpawns = new ArrayList<BlockPos>(1);
