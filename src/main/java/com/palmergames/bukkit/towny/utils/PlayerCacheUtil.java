...
public class PlayerCacheUtil {
	 ...
	 * @param location - BlockPos 
	 * @param material - Material
	 * @param action - ActionType
	 * @return true if the player has permission.
	 */
	public static boolean getCachePermission(Player player, BlockPos location, Material material, ActionType action) {
	 ...
	 * @param action - ActionType
	 */
	private static void triggerCacheCreate(Player player, BlockPos location, WorldCoord worldCoord, TownBlockStatus status, Material material, ActionType action) {
	...
	public static TownBlockStatus getTownBlockStatus(Player player, WorldCoord worldCoord) {
		...
		if (resident == null) {
			...
			if (resident == null) {
				...
				plugin.getLogger().warn("Failed to fetch resident: " + player.getName());
				return TownBlockStatus.NOT_REGISTERED;
			}
		}
