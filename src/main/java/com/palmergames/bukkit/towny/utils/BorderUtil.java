...
public class BorderUtil {
	...
	public static boolean allowedMove(Block block, Block blockTo, @Nullable Player player) {
		...
		if (player != null 
			&& PlayerCacheUtil.getCachePermission(player, blockTo.getBlockPos(), block.getType(), ActionType.BUILD)
			&& PlayerCacheUtil.getCachePermission(player, block.getBlockPos(), block.getType(), ActionType.BUILD))
			return true;
